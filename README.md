...
2. Unzip the included `player_stats.csv.zip` file.
3. Modify the `csv_file_path` variable in the script to point to the unzipped `player_stats.csv` file containing player statistics.
4. Run the script using a Python interpreter: `python fantasy_football_scoring_adjuster.py`
